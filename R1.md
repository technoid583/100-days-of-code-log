...
However, I found usefull resources across the web, there we go — [Free e-book Eloquent JavaScript](https://eloquentjavascript.net/) and [Modern JavaScript Tutorial - Javascript.RU](Phttps://learn.javascript.ru)
