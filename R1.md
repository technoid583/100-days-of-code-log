...
**Today's Progress**: (Step - 117) Completed Pyrdamid-Generator project. / uncommenting, practiced using booleans as a flag to check. [you can see code below given as an snippet from the project]
